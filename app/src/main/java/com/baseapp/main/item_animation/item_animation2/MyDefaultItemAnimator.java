...
public class MyDefaultItemAnimator extends SimpleItemAnimator {
    ...
    public boolean animateAdd(final RecyclerView.ViewHolder holder) {
        ...
        if (holder.getAdapterPosition() % 2 == 0) {
            ...
            holder.itemView.setTranslationY(-holder.itemView.getTop() + 100);
        } else {
            holder.itemView.setTranslationX(800);
            holder.itemView.setTranslationY(-holder.itemView.getTop() + 100);
        }
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null && newView != null) {
            ...
            final ViewPropertyAnimator oldViewAnim = view.animate().setDuration(
                    getChangeDuration());
            oldViewAnim.translationX(changeInfo.toX - changeInfo.fromX - (view.getWidth() - newView.getWidth()) / 2f)
                    .scaleX(newView.getWidth() / (float) view.getWidth())
                    .scaleY(newView.getHeight() / (float) view.getHeight())
                    .translationY(changeInfo.toY - changeInfo.fromY - (view.getHeight() - newView.getHeight()) / 2f)
                    .setListener(new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationStart(Animator animator) {
