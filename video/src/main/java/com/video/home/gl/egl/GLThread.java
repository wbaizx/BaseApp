...
import com.video.home.gl.renderer.CodecRenderer;
import com.video.home.gl.renderer.FBORenderer;
import com.video.home.gl.renderer.ScreenRenderer;
...
public class GLThread extends Thread {
    ...
    private final Condition condition = look.newCondition();
    ...
    private final FBORenderer fboRenderer = new FBORenderer();
    ...
    public void takePicture() {
        if (isSurfaceCreated && fboEglSurface != null && eglContext != null) {
            ...
            if (cameraControlListener != null) {
                SavePicture.Picture picture = new SavePicture.Picture(fboRenderer.takePicture());
                //在Android平台中，Bitmap绑定的2D纹理，是上下颠倒的
                picture.setVerticalMirror(true);
