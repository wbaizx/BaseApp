package com.video.home.gl.renderer;
...
import com.video.home.gl.renderer.filter.BaseFilter;
...
public class FBORenderer extends BaseRenderer {
    ...
    private final FloatBuffer vertexBuffer = GLHelper.getFloatBuffer(new float[]{
            -1.0f, 1.0f, //左上
            -1.0f, -1.0f, //左下
            1.0f, 1.0f,  //右上
            1.0f, -1.0f,  //右下
    ...
    private final FloatBuffer textureCoordBuffer = GLHelper.getFloatBuffer(new float[]{
            0.0f, 1.0f, //左上
            0.0f, 0.0f, //左下
            1.0f, 1.0f, //右上
            1.0f, 0.0f, //右下
    ...
    private final ArrayList<BaseRenderer> rendererList = new ArrayList<>();
